...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Writing, Defination = "Create Product")]
        ...
        [HttpPut]
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Updating, Defination = "Update Product")]
        ...
        [HttpDelete("{Id}")]
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Deleting, Defination = "Delete Product")]
        ...
        [HttpPost("[action]")]
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Writing, Defination = "Upload Product File")]
        ...
        [HttpGet("[action]/{Id}")]
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Reading, Defination = "Get Product Images")]
        ...
        [Authorize(AuthenticationSchemes = "Admin")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Deleting, Defination = "Delete Product Image")]
        ...
        [HttpGet("[action]")]
        [Authorize(AuthenticationSchemes="Admin")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstans.Products, ActionType = ActionType.Updating, Defination = "Change Showcase Image")]
